...
static int var_0 = 599; // Initial value from Z3 model
static int var_1 = 797; // Initial value from Z3 model
static int var_2 = 40; // Initial value from Z3 model
static int var_3 = -238; // Initial value from Z3 model
static int var_4 = 360; // Initial value from Z3 model
static int var_5 = 180; // Initial value from Z3 model
static int var_6 = -997; // Initial value from Z3 model
static int var_7 = -566; // Initial value from Z3 model
static int var_8 = 843; // Initial value from Z3 model
static int var_9 = 74; // Initial value from Z3 model
static int var_10 = -349; // Initial value from Z3 model
static int var_11 = -227; // Initial value from Z3 model
static int var_12 = 445; // Initial value from Z3 model
static int var_13 = -814; // Initial value from Z3 model
static int var_14 = 934; // Initial value from Z3 model
