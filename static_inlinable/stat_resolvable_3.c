...
static int var_0 = -140; // Initial value from Z3 model
static int var_1 = -21; // Initial value from Z3 model
static int var_2 = 36; // Initial value from Z3 model
static int var_3 = -441; // Initial value from Z3 model
static int var_4 = 635; // Initial value from Z3 model
static int var_5 = 260; // Initial value from Z3 model
static int var_6 = 465; // Initial value from Z3 model
static int var_7 = -929; // Initial value from Z3 model
