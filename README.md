...
# Check the UB-freeness of the generated functions
python3 scripts/ubchk.py <procedures> <mappings>

# Check the UB-freeness of the generated programs
python3 scripts/ubchk.py <new_procedures>
```
